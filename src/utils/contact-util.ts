...
export const updateContact = (
  ...
  return {
    ...
    city             : newContact.City || oldContact.city,
    ...
    province         : newContact.Province || oldContact.province,
    remark           : newContact.Remark || oldContact.remark,
    sex              : newContact.Sex || oldContact.sex,
    signature        : newContact.Signature || oldContact.signature,
    smallHeadUrl     : newContact.SmallHeadImgUrl || oldContact.smallHeadUrl,
    stranger         : newContact.EncryptUsername || oldContact.stranger,
    ticket           : newContact.Ticket || oldContact.ticket,
