...
test('messageRawPayloadParser', async t => {
  ...
  t.skip('tbw')
  // t.test('text', async t => {
  //   const PADCHAT_MESSAGE_PAYLOAD_TEXT: PadproMessagePayload = {
  //     content     : '1111',
  //     continue    : 1,
  ...
  //   const PADCHAT_MESSAGE_PAYLOAD_VOICE: PadproMessagePayload = {
...
test('sys', async t => {
  const PADCHAT_MESSAGE_PAYLOAD_SYS: PadproMessagePayload = {
