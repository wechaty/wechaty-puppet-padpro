import { PadproEmojiMessagePayload, PadproMessagePayload } from '../schemas'
import { isPayload } from './is-type'
import { xmlToJson } from './xml-to-json'

export async function emojiPayloadParser (rawPayload: PadproMessagePayload): Promise<PadproEmojiMessagePayload | null> {
