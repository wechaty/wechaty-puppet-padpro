import { PadproImageMessagePayload, PadproMessagePayload } from '../schemas'
import { isPayload } from './is-type'
import { xmlToJson } from './xml-to-json'

export async function imagePayloadParser (rawPayload: PadproMessagePayload): Promise<PadproImageMessagePayload | null> {
  ...
  try {
    ...
    const result: PadproImageMessagePayload = {
