...
/**
 * There are two functions to generate PadproContactPayload
...
export interface PadproMessagePayload {
  ...
  messageType  : PadproMessageType        // 5
  status       : PadproMessageStatus,     // 1
  timestamp    : number,
 ...
 * from Message
 */
// export interface PadproRecomendInfo {
//   UserName:   string,
...
// export const enum PadproMediaType {
//   Image      = 1,
//   Video      = 2,
//   Audio      = 3,
//   Attachment = 4,
...
export interface PadproRoomMemberPayload {
  contactId: string,
  nickName: string,
  displayName: string,
  bigHeadUrl: string,
...
export interface PadproMemberBrief {
  userName : string,
  nickName?: string,
}

/**
 * @interface PadproRoomPayload
 */
export interface PadproRoomPayload {
  alias          : string,
  bigHeadUrl     : string,
...
export interface PadproEmojiMessagePayload {
  cdnurl: string,
  type  : PadproEmojiType,
  len   : number,
  width : number,
  height: number,
}

export interface PadproImageMessagePayload {
  aesKey: string,
  encryVer: number,
  cdnThumbAesKey: string,
  cdnThumbUrl: string,
...
export interface PadproRequestTokenPayload {
  full_url        : string,
  info            : string,
  message         : string,
  share_url       : string,
